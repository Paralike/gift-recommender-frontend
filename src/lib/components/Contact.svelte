  ...
  <section class="grid grid-cols-1 md:grid-cols-2 gap-8">
    <div>
      <div class="mb-4">
        ...
        <h2 class="text-3xl md:text-4xl font-bold">Make your life easier</h2>
      </div>
      <p class="mb-8 text-muted-foreground lg:w-5/6">
        We are working on to make make the best possible experience for you. But at this stage we can only provide it to a groving number of users. Join us.
      </p>
